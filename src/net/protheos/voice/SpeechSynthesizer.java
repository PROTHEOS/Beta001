 ...
 * Filename: SpeechSynthesizer.java
...
public class SpeechSynthesizer
{
	...
	public SpeechSynthesizer(String name)
	{
		...
		Voice theVoice = new Voice(name, Voice.GENDER_NEUTRAL, Voice.AGE_DONT_CARE, null);
		try
		{		
			...
			{
				VoiceUtils.log("ERROR", "Cannot create speech synthesizer");
				System.exit(1);
			}
	...
	public static void main(String[] argv){
		SpeechSynthesizer s = new SpeechSynthesizer("PRO.T.H.E.O.S");
		s.synthesize("Socrates is a Man!");
		s.synthesize("If Man is Mortal!");
		s.synthesize("Then Socrates is Mortal!");
